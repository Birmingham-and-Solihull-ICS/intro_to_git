...
<br>
__One solutions is a .gitignore file, which we will use in BSOL template.__
...
2. Start on github, create a repository and clone it you machine to work on.  __Recommended with BSOL template__
...
+ use tools to help:
  ...
  + Use a template with these standards as a starting point: e.g. BSOL template or Government Data Science Cookie Cutter.
  

---
# BSOL ICS GitHub organsiation

+ To manager our organisations projects, we have a 'GitHub Organisation'.  Several administrators/owners, but come to me with queries.
...
![](./img/BSOL_github_template.png)

https://github.com/Birmingham-and-Solihull-ICS/BSOLproject
]
---
# Using the BSOL ICS GitHub template

.pull-left[

__When creating a new repository:__

+ Set the template to 'Birmingham-and-Solihull-ICS/BSOLproject'

+ Set the 'Owner' to 'Birmingham-and-Solihull-ICS'

+ In general, we should look to publish in the public rather than private, but you can change this setting any time if you are concerned.

]

.pull-right[

![](./img/using_bsol_template.png)

]
---

# Using GitHub at BSOL
...
+ We have an BSOL GitHub organisation, let me know your username and I'll make you part of the organisation

+ BSOL template has been thought out to help prevent accidental publishing of data files. __Please use it!__

+ To use it, create a new repository on GitHub based on the template, then clone it to your machine before starting work.
